...
io.on('connection', function(socket) {
    ...
    socket.on('phraseSkipButtonPressed', () => { showNextPhrase(socket) });
...
setInterval(()=>{
    ...
    for (let roomName in ROOM_LIST){
        ...
        if (roomObj.game.timer < 0){  // If timer runs out...
            ...
            roomObj.game.changeNextPlayer(); //** Switch to the next player on the benched team
