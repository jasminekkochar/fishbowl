class Game {
    ...
    changeNextPlayer(){
        let nonActiveTeam = (this.activeTeam === "blueTeam") ? 'redTeam' : 'blueTeam';
        let benchTeam = this[nonActiveTeam];
        benchTeam.activePlayer = (benchTeam.activePlayer + 1) % benchTeam.playerIds.length;
        benchTeam.nextPlayer = (benchTeam.nextPlayer + 1) % benchTeam.playerIds.length;
    }
